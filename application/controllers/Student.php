...
class Student extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        $data['departmentsList']    = $this->student_model->getDepartments();
        $data['languageList']       = $this->student_model->getLanguages();
    ...
    public function create_doc()
    {
        ...
        $this->form_validation->set_rules('first_title', $this->lang->line('title'), 'trim|required|xss_clean');
          $this->form_validation->set_rules('first_doc', $this->lang->line('document'), 'file_validate');
