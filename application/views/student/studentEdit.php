                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                     ...
                                     <?php }if ($sch_setting->roll_no) {?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('other_language'); ?></label><small class="req"> </small>
                                                <select  id="other_lang" name="other_lang" class="form-control"  >
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php  foreach ($languageList as $lang) {
                                                        echo $student['other_lang'];
                                                        ?>
                                                        <option value="<?php echo $lang->id ?>"<?php if ($student['other_lang'] == $lang->id) {
                                                            echo "selected=selected";
                                                        }
                                                        ?>><?php echo $lang->name ?></option>
                                                    <?php }?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('other_lang'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('department_s'); ?></label><small class="req"> </small>
                                                <select  id="department" name="department" class="form-control"  >
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php foreach ($departmentsList as $department) {
                                                        ?>
                                                        <option value="<?php echo $department->id ?>"<?php if ($student['department'] == $department->id) {
                                                            echo "selected=selected";
                                                        }
