                    ...
                    if (isset($timetable)) {
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($timetable)) {
                                ...
                                ?>
                            <div class="box-footer">
                            <form action="<?php echo site_url('admin/timetable/edittable') ?>" method="post" accept-charset="utf-8">
                            <input type="hidden" name="table_id" value="<?php echo $timetable[0]->id ?>">
                            <input type="hidden" name="class_id" value="<?php echo $class_id ?>">
                            <button type="submit" class="btn btn-primary pull-right btn-sm" name="edit"><?php echo $this->lang->line('edit'); ?></button>
                            </form>
                        </div>
                            <div class="table-responsive">    
                                <table class="table table-stripped text-center">
                                    ...
                                    <?php foreach($timetable as $table):?>
                                        ...
                                        <tr>
                                            <td><?php //print_r(json_decode($table->saturday)) ?>Saturday</td>
                                            <?php
                                            foreach(json_decode($table->saturday) as $day):?>
                                            <td>
                                           
                                            <?php  if(!empty($this->subjecttimetable_model->getSubjectName($day->subject_id)[0]->name)){
                                                echo $this->subjecttimetable_model->getSubjectName($day->subject_id)[0]->name;
                                            }
                                            echo '<br>'.$day->time_from.' to '.$day->time_to.'<br>';
                                            
                                            if(!empty($this->subjecttimetable_model->getstaffName($day->teacher_id)[0]->name)){
                                                echo $this->subjecttimetable_model->getstaffName($day->teacher_id)[0]->name;
                                            }
                                            ?></td>
                                            <?php endforeach;?>
                                           </tr>
                                        ...
                                        <tr>
                                            <td><?php //print_r(json_decode($table->saturday)) ?>sunday</td>
                                            <?php
                                            foreach(json_decode($table->sunday) as $day):?>
                                            <td><?php  if(!empty($this->subjecttimetable_model->getSubjectName($day->subject_id)[0]->name)){
                                                echo $this->subjecttimetable_model->getSubjectName($day->subject_id)[0]->name;
                                            }
                                            echo '<br>'.$day->time_from.' to '.$day->time_to.'<br>'.$day->teacher_id ?></td>
                                            <?php endforeach;?>
                                           </tr>
                                        <?php endif;?>
                                        <?php if(!empty(json_decode($table->monday))):?>
                                        <tr>
                                            <td><?php //print_r(json_decode($table->saturday)) ?>monday</td>
                                            <?php
                                        ...
                                        <tr>
                                            <td><?php //print_r(json_decode($table->saturday)) ?>tuesday</td>
                                            <?php
                                            foreach(json_decode($table->tuesday) as $day):?>
                                            <td><?php  if(!empty($this->subjecttimetable_model->getSubjectName($day->subject_id)[0]->name)){
                                                echo $this->subjecttimetable_model->getSubjectName($day->subject_id)[0]->name;
                                            }
                                            echo '<br>'.$day->time_from.' to ';
                                            if(!empty($this->subjecttimetable_model->getstaffName($day->teacher_id)[0]->name)){
                                            echo $this->subjecttimetable_model->getstaffName($day->teacher_id)[0]->name;
                                        }
                                            ?></td>
                                        ...
                                        <tr>
                                            <td><?php //print_r(json_decode($table->saturday)) ?>wedneday</td>
                                            <?php
                                        ...
                                        <tr>
                                            <td><?php //print_r(json_decode($table->saturday)) ?>thursday</td>
                                            <?php
                                        ...
                                        <tr>
                                            <td><?php //print_r(json_decode($table->saturday)) ?>friday</td>
                                            <?php
