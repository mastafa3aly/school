                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6 img_div_modal">
                                                    <div class="staffinfo-box">
                                                        ...
                                                        <div class="staffleft-content">
                                                            ...
                                                            <p><font data-toggle="tooltip" title="<?php echo $this->lang->line('national_id'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $staff["national_id"] ?></font></p>
