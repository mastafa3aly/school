...
class Subjecttimetable_model extends MY_Model
{
    ...
    public function getClassTimeTable($class_id, $section_id){
        $this->db->select('*');
    ...
    public function updateDayTimeTable($data,$id){
        $this->db->where('id', $id);
       $result= $this->db->update('time_table',$data);
      if($result){
          return TRUE;
      }else{
          return FALSE;
    ...
    public function insertDayTimeTable($data){
